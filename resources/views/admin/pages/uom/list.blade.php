...
<div class="row">
    <div class="col-md-3">
      <div class="card">
          <h4 class="card-header">Add UOM</h4>
          <div class="card-body">
            <form action="{{ URL::To('admin/experiance/category/add-action-category')}}" method="post">
              ...
              <div class="form-group">
                  ...
                  <input type="text" placeholder="UOM Name" required name="category_name" value="{{ isset($category) ? $category->category_name : '' }}" class="form-control">
              </div>
